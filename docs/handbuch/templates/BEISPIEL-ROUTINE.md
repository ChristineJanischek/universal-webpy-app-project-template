...
**Abhängigkeiten:**
- 🔗 `KF-ROUTINE-002-GIT-STATUS.md` (Must-Have, Beispielname)
  - Muss vor dieser Routine durchgefuehrt werden
...
- 🔗 `KF-ROUTINE-002-GIT-STATUS.md` (Vorbedingung, Beispielname)
- 🔗 `KF-ROUTINE-003-CODE-REVIEW.md` (Nachgelagert, Beispielname)
- 🔗 `MF-ROUTINE-001-QUALITY-AUDIT.md` (Verwandt, Beispielname)
