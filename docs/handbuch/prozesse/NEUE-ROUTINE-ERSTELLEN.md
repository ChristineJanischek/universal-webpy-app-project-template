...
- Format: `[KATEGORIE-ROUTINE-XXX]-AUSSAGEKRAEFTIGER-NAME.md`
   - Kategorien: `KF` (kurzfristig), `MF` (mittelfristig), `LF` (langfristig)
   - ID: Fortlaufend in jeder Kategorie (001, 002, 003, ...)
- Name: GROSSBUCHSTABEN, Bindestriche, max. 50 Zeichen
...
1. **Index in der Kategorie-Datei aktualisieren:**
   ...
   echo "- [KF-ROUTINE-XXX: Name](DATEINAME-DER-ROUTINE)" >> docs/handbuch/routinen/kurzfristig/INDEX.md
   ```
